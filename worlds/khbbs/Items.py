...
item_table: Dict[str, KHBBSItemData] = {
   ...
   #"Cartwheel":              KHBBSItemData("Movement Command",   code = 227_0010162, classification = ItemClassification.useful,      characters = "  A", max_quantity = 1, khbbsid = "00FD"),
    ...
    "Air Slide":              KHBBSItemData("Movement Command",   code = 227_0010164, classification = ItemClassification.useful,      characters = "TVA", max_quantity = 1, khbbsid = "00FF"),
    "Ice Slide":              KHBBSItemData("Movement Command",   code = 227_0010165, classification = ItemClassification.useful,      characters = "TVA", max_quantity = 1, khbbsid = "0100"),
    ...
    "Fire Glide":             KHBBSItemData("Movement Command",   code = 227_0010169, classification = ItemClassification.useful,      characters = " V ", max_quantity = 1, khbbsid = "0104"),
    ...
    "Teleport":               KHBBSItemData("Movement Command",   code = 227_0010171, classification = ItemClassification.useful,      characters = "TVA", max_quantity = 1, khbbsid = "0106"),
    ...
    "Double Flight":          KHBBSItemData("Movement Command",   code = 227_0010173, classification = ItemClassification.progression, characters = "  A", max_quantity = 1, khbbsid = "0108"),
   ...
   #"Shotlock":               KHBBSItemData("Shotlock Command",   code = 227_0010192, classification = ItemClassification.useful,      characters = "TVA", max_quantity = 1, khbbsid = "011B"),
    ...
    "Flame Salvo":            KHBBSItemData("Shotlock Command",   code = 227_0010194, classification = ItemClassification.useful,      characters = "TVA", max_quantity = 1, khbbsid = "011D"),
   ...
   #"Sonic Shadow":           KHBBSItemData("Shotlock Command",   code = 227_0010206, classification = ItemClassification.useful,      characters = "T  ", max_quantity = 1, khbbsid = "0129"),
    ...
    "Thunder Bolt":           KHBBSItemData("Command Style",      code = 227_0020005, classification = ItemClassification.useful,      characters = "TVA", max_quantity = 1, khbbsid = "0157"),
   ...
   #"Zero EXP":               KHBBSItemData("Ability",            code = 227_0030005, classification = ItemClassification.useful,      characters = "TVA", max_quantity = 1),
    ...
    "(V) Hyper Drive":        KHBBSItemData("Key Item",           code = 227_0040007, classification = ItemClassification.useful,      characters = " V ", max_quantity = 1, khbbsid = "0007"),
    ...
    "(V) Frolic Flame":       KHBBSItemData("Key Item",           code = 227_0040011, classification = ItemClassification.useful,      characters = " V ", max_quantity = 1, khbbsid = "000D"),
    "(V) Lost Memory":        KHBBSItemData("Key Item",           code = 227_0040012, classification = ItemClassification.useful,      characters = " V ", max_quantity = 1, khbbsid = "000E"),
    ...
    "(T) No Name":            KHBBSItemData("Key Item",           code = 227_0040275, classification = ItemClassification.useful,      characters = "T  ", max_quantity = 1, khbbsid = "0111"),
    "(T) Royal Radiance":     KHBBSItemData("Key Item",           code = 227_0040276, classification = ItemClassification.useful,      characters = "T  ", max_quantity = 1, khbbsid = "0112"),
    ...
    "Wayfinder Aqua":         KHBBSItemData("Key Item",           code = 227_0047966, classification = ItemClassification.progression, characters = "TVA", max_quantity = 1, khbbsid = "1F1D"),
    "Wayfinder Terra":        KHBBSItemData("Key Item",           code = 227_0047967, classification = ItemClassification.progression, characters = "TVA", max_quantity = 1, khbbsid = "1F20"),
