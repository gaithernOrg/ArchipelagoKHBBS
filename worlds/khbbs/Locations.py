...
location_table: Dict[str, KHBBSLocationData] = {
    ...
    "(T) Land of Departure Orbs Defeated Critical Impact":                     KHBBSLocationData("Land of Departure",  227_1220001),
    "(T) Land of Departure Orbs Defeated Ventus D-Link":                       KHBBSLocationData("Land of Departure",  227_1220002),
    "(T) Land of Departure Orbs Defeated Aqua D-Link":                         KHBBSLocationData("Land of Departure",  227_1220003),
    "(T) Land of Departure Eraqus Defeated Max HP Increase":                   KHBBSLocationData("Land of Departure",  227_1220004),
    "(T) Land of Departure Eraqus Defeated Chaos Ripper":                      KHBBSLocationData("Land of Departure",  227_1220005),
    "(T) Land of Departure Eraqus Defeated Xehanort's Report 8":               KHBBSLocationData("Land of Departure",  227_1220006),
    "(T) Dwarf Woodlands Unversed Group Defeated Air Slide":                   KHBBSLocationData("Dwarf Woodlands",    227_1220100),
    "(T) Dwarf Woodlands Spirit of the Magic Mirror Defeated Max HP Increase": KHBBSLocationData("Dwarf Woodlands",    227_1220101),
    "(T) Dwarf Woodlands Spirit of the Magic Mirror Defeated Firestorm":       KHBBSLocationData("Dwarf Woodlands",    227_1220102),
    "(T) Dwarf Woodlands Spirit of the Magic Mirror Defeated Treasure Trove":  KHBBSLocationData("Dwarf Woodlands",    227_1220103),
    ...
    "(T) Olympus Coliseum Tournament Complete Max HP Increase":                KHBBSLocationData("Olympus Coliseum",   227_1220700),
    "(T) Olympus Coliseum Tournament Complete Sonic Impact":                   KHBBSLocationData("Olympus Coliseum",   227_1220701),
    "(T) Olympus Coliseum Defeat Zack Deck Capacity Increase":                 KHBBSLocationData("Olympus Coliseum",   227_1220702),
    "(T) Olympus Coliseum Defeat Zack Zack D-Link":                            KHBBSLocationData("Olympus Coliseum",   227_1220703),
    "(T) Olympus Coliseum Defeat Zack Mark of a Hero":                         KHBBSLocationData("Olympus Coliseum",   227_1220704),
    "(T) Deep Space Defeat Unversed in Space Max HP Increase":                 KHBBSLocationData("Deep Space",         227_1220800),
    "(T) Deep Space Defeat Experiment 221 Thunderbolt":                        KHBBSLocationData("Deep Space",         227_1220801),
    "(T) Deep Space Defeat Experiment 221 Experiment 626 D-Link":              KHBBSLocationData("Deep Space",         227_1220802),
    "(T) Deep Space Defeat Experiment 221 Hyperdrive":                         KHBBSLocationData("Deep Space",         227_1220803),
    "(T) Deep Space Defeat Experiment 221 Spaceship Board":                    KHBBSLocationData("Deep Space",         227_1220804),
    "(T) Destiny Islands Scene Ends of the Earth":                             KHBBSLocationData("Destiny Islands",    227_1220800),
    "(T) Neverland Defeat Peter Pan Bladecharge":                              KHBBSLocationData("Neverland",          227_1221000),
    "(T) Neverland Defeat Peter Pan Peter Pan D-Link":                         KHBBSLocationData("Neverland",          227_1221001),
    "(T) Neverland Defeat Countless Unversed Deck Capacity Increase":          KHBBSLocationData("Neverland",          227_1221002),
    "(T) Neverland Defeat Countless Unversed Pixie Petal":                     KHBBSLocationData("Neverland",          227_1221003),
    "(T) Neverland Defeat Countless Unversed Skull Board":                     KHBBSLocationData("Neverland",          227_1221004),
    "(T) Disney Town Complete Rumble Racing Hi-Potion":                        KHBBSLocationData("Disney Town",        227_1221100),
    "(T) Disney Town Complete Rumble Racing Toon Board":                       KHBBSLocationData("Disney Town",        227_1221101),
    "(T) Keyblade Graveyard Meet With Xehanort Dark Impulse":                  KHBBSLocationData("Keyblade Graveyard", 227_1221200),
    "(T) Keyblade Graveyard Xehanort Defeated Max HP Increase":                KHBBSLocationData("Keyblade Graveyard", 227_1221201),
    "(T) Keyblade Graveyard Defeat Terranort":                                 KHBBSLocationData("Keyblade Graveyard", 227_1221202),
}
