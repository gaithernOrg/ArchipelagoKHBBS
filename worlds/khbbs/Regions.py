...
def create_regions(multiworld: MultiWorld, player: int, options):
    ...
    if options.character == 0:
        ...
        regions["The Land of Departure"].locations.append("(V) The Land of Departure Orbs Defeated Max HP Increase")
        regions["The Land of Departure"].locations.append("(V) The Land of Departure Orbs Defeated Fever Pitch")
        regions["The Land of Departure"].locations.append("(V) The Land of Departure Orbs Defeated Aqua D-Link")
        regions["The Land of Departure"].locations.append("(V) The Land of Departure Orbs Defeated Terra D-Link")
        regions["The Land of Departure"].locations.append("(V) The Land of Departure Orbs Defeated Xehanort's Letter")
        regions["The Land of Departure"].locations.append("(V) The Land of Departure Orbs Defeated Keyblade Board")
        regions["Dwarf Woodlands"].locations.append("(V) Dwarf Woodlands Snow White Escorted Max HP Increase")
        regions["Dwarf Woodlands"].locations.append("(V) Dwarf Woodlands Mad Treant Defeated Deck Capacity Increase")
        regions["Dwarf Woodlands"].locations.append("(V) Dwarf Woodlands Mad Treant Defeated Firestorm")
        regions["Dwarf Woodlands"].locations.append("(V) Dwarf Woodlands Mad Treant Defeated Snow White D-Link")
        regions["Dwarf Woodlands"].locations.append("(V) Dwarf Woodlands Mad Treant Defeated Treasure Trove")
        regions["Castle of Dreams"].locations.append("(V) Castle of Dreams Lucifer Defeated Diamond Dust")
        regions["Castle of Dreams"].locations.append("(V) Castle of Dreams Lucifer Defeated Cinderella D-Link")
        regions["Castle of Dreams"].locations.append("(V) Castle of Dreams Lucifer Defeated Stroke of Midnight")
        regions["Castle of Dreams"].locations.append("(V) Castle of Dreams Lucifer Defeated Royal Board")
        regions["Enchanted Dominion"].locations.append("(V) Enchanted Dominion Maleficent Defeated Max HP Increase")
        regions["Enchanted Dominion"].locations.append("(V) Enchanted Dominion Maleficent Defeated Thunderbolt")
        regions["Enchanted Dominion"].locations.append("(V) Enchanted Dominion Maleficent Defeated Fairy Stars")
        regions["The Mysterious Tower"].locations.append("(V) The Mysterious Tower Met Donald and Goofy Donald D-Link")
        regions["The Mysterious Tower"].locations.append("(V) The Mysterious Tower Met Donald and Goofy Goofy D-Link")
        regions["Radiant Garden"].locations.append("(V) Radiant Garden Meet Scrooge Disney Town Pass")
        regions["Radiant Garden"].locations.append("(V) Radiant Garden Examine Pooh's Story Book Honey Pot Board")
        regions["Radiant Garden"].locations.append("(V) Radiant Garden Trinity Armor Defeated Max HP Increase")
        regions["Radiant Garden"].locations.append("(V) Radiant Garden Trinity Armor Defeated Cyclone")
        regions["Radiant Garden"].locations.append("(V) Radiant Garden Rescue Ienzo Reversal")
        regions["Radiant Garden"].locations.append("(V) Radiant Garden World Complete Frolic Flame")
        ...
        regions["Olympus Coliseum"].locations.append("(V) Olympus Coliseum Countless Unversed Defeated Air Slide")
        regions["Olympus Coliseum"].locations.append("(V) Olympus Coliseum Countless Unversed Defeated Zack D-Link")
        regions["Olympus Coliseum"].locations.append("(V) Olympus Coliseum Countless Unversed Defeated Mark of a Hero")
        regions["Deep Space"].locations.append("(V) Deep Space Giant Unversed 1 Defeated Wingblade")
        regions["Deep Space"].locations.append("(V) Deep Space Giant Unversed 2 Defeated Max HP Increase")
        regions["Deep Space"].locations.append("(V) Deep Space Giant Unversed 2 Defeated Deck Capacity Increase")
        regions["Deep Space"].locations.append("(V) Deep Space Giant Unversed 2 Defeated Experiment 626 D-Link")
        regions["Deep Space"].locations.append("(V) Deep Space Giant Unversed 2 Defeated Hyperdrive")
        regions["Deep Space"].locations.append("(V) Deep Space Giant Unversed 2 Defeated Spaceship Board")
        ...
        regions["Never Land"].locations.append("(V) Never Land Defeat Captain Hook Peter Pan D-Link")
        regions["Never Land"].locations.append("(V) Never Land Defeat Captain Hook Pixie Petal")
        regions["Never Land"].locations.append("(V) Never Land Defeat Captain Hook Skull Board")
        regions["Disney Town"].locations.append("(V) Disney Town Ice Cream Beat Complete Toon Board")
        regions["The Keyblade Graveyard"].locations.append("(V) The Keyblade Graveyard Defeat Vanitas 2 Max HP Increase")
        regions["The Keyblade Graveyard"].locations.append("(V) The Keyblade Graveyard Defeat Vanitas 2 Deck Capacity Increase")
        regions["The Keyblade Graveyard"].locations.append("(V) The Keyblade Graveyard Defeat Vanitas 2 High Jump")
        regions["The Keyblade Graveyard"].locations.append("(V) The Keyblade Graveyard Defeat Vanitas 2 Mickey D-Link")
        regions["The Keyblade Graveyard"].locations.append("(V) The Keyblade Graveyard Defeat Vanitas 2 Lost Memory")
        regions["The Keyblade Graveyard"].locations.append("(V) The Keyblade Graveyard Defeat Vanitas 2 Xehanort's Report 9")
        regions["The Keyblade Graveyard"].locations.append("(V) The Keyblade Graveyard Defeat Final Vanitas Xehanort's Report 10")
