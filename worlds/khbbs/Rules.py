...
def set_rules(khbbsworld):
    ...
    if options.character == 0:
        ...
        multiworld.get_location("(V) Olympus Coliseum Coliseum Gates Confetti Sticker"          , player).access_rule = lambda state: state.has("High Jump", player) or state.has("Glide", player) or state.has("Sliding Dash", player) or state.has("Air Slide", player)
        multiworld.get_location("(V) Never Land Rainbow Falls: Base Rainbow Sticker"            , player).access_rule = lambda state: state.has("High Jump", player) and state.has("Glide", player)
        multiworld.get_location("(V) Never Land Mermaid Lagoon Dale Sticker"                    , player).access_rule = lambda state: state.has("Glide", player) or state.has("Sliding Dash", player)
        multiworld.get_location("(V) Never Land Cliff Path Firaga Chest"                        , player).access_rule = lambda state: state.has("Glide", player) or state.has("Sliding Dash", player)
        multiworld.get_location("(V) Never Land Mermaid Lagoon Blitz Chest"                     , player).access_rule = lambda state: state.has("Glide", player) or state.has("Sliding Dash", player)
        multiworld.get_location("(V) Disney Town Gizmo Gallery Mega-Potion Chest 2"             , player).access_rule = lambda state: state.has("Thunder", player) or state.has("Thundara", player) or state.has("Thundaga", player)
        multiworld.get_location("(V) Disney Town Gizmo Gallery Chaos Crystal Chest"             , player).access_rule = lambda state: state.has("Thunder", player) or state.has("Thundara", player) or state.has("Thundaga", player)
        multiworld.get_location("(V) Disney Town Gizmo Gallery Mega-Potion Chest 1"             , player).access_rule = lambda state: state.has("Thunder", player) or state.has("Thundara", player) or state.has("Thundaga", player)
        multiworld.get_location("(V) Disney Town Gizmo Gallery Mickey Sticker"                  , player).access_rule = lambda state: state.has("Thunder", player) or state.has("Thundara", player) or state.has("Thundaga", player)
        multiworld.get_location("(V) Disney Town Gizmo Gallery Mega-Ether Chest"                , player).access_rule = lambda state: state.has("Thunder", player) or state.has("Thundara", player) or state.has("Thundaga", player)
        multiworld.get_location("(V) Disney Town Pete's Rec Room Panacea Chest"                 , player).access_rule = lambda state: state.has("Thunder", player) or state.has("Thundara", player) or state.has("Thundaga", player)
        multiworld.get_location("(V) Disney Town Pete's Rec Room Action Recipe Chest"           , player).access_rule = lambda state: state.has("Thunder", player) or state.has("Thundara", player) or state.has("Thundaga", player)
        multiworld.get_location("(V) Disney Town Pete's Rec Room Break Time Chest"              , player).access_rule = lambda state: state.has("Thunder", player) or state.has("Thundara", player) or state.has("Thundaga", player)
        multiworld.get_location("(V) Disney Town Pete's Rec Room Minnie Sticker"                , player).access_rule = lambda state: state.has("Thunder", player) or state.has("Thundara", player) or state.has("Thundaga", player)
        multiworld.get_location("(V) Disney Town Pete's Rec Room Aerial Slam Chest"             , player).access_rule = lambda state: state.has("Thunder", player) or state.has("Thundara", player) or state.has("Thundaga", player)
        multiworld.get_location("(V) Disney Town Pete's Rec Room Wellspring Crystal Chest"      , player).access_rule = lambda state: state.has("Thunder", player) or state.has("Thundara", player) or state.has("Thundaga", player)
        multiworld.get_location("(V) Disney Town Raceway Slot Edge Chest"                       , player).access_rule = lambda state: state.has("Thunder", player) or state.has("Thundara", player) or state.has("Thundaga", player)
        multiworld.get_location("(V) Disney Town Raceway Chip Sticker"                          , player).access_rule = lambda state: state.has("Thunder", player) or state.has("Thundara", player) or state.has("Thundaga", player)
        multiworld.get_location("(V) Disney Town Raceway Superglide Chest"                      , player).access_rule = lambda state: (state.has("Thunder", player) or state.has("Thundara", player) or state.has("Thundaga", player)) and state.has("Glide", player)
